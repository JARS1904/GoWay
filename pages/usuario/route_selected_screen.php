        ...
        <div class="header-content">
            ...
            <nav class="header-nav">
                ...
                <?php else: ?>
                    ...
                    <button class="profile-nav-btn" onclick="openReportModal()" title="Nuevo reporte" style="width: auto; padding: 5px; margin-right: 15px; color: var(--dark-gray); background: transparent; border: none; cursor: pointer; font-size: 20px;">
